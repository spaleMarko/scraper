...
const getData = async () => {
    ...
    await page.goto('https://www.idealo.de/preisvergleich/OffersOfProduct/201846460_-aspirin-plus-c-forte-800-mg-480-mg-brausetabletten-bayer.html');
    ...
    const listOfProducts = []
     ...
     if (productList) {
      ...
      for (const productItem of productItems) {
        ...
        try{
        // Get single product
        response = await productItem.$eval('a', element => element.getAttribute('data-gtm-payload'));
        }catch(e){
            response = null
        }
        ...
        if(response){
            ...
            console.error('The product not found check the selector for the product');
          }
